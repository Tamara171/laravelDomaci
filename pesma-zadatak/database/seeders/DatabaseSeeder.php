...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $pesma1 = Pesma::create(['name'=> "Tom's diner",'duration'=>"3", 'award'=>"No",'izvodjac_id'=>"3", 'album_id'=>"1" ]);
        $pesma2 = Pesma::create(['name'=> "Womanizer",'duration'=>"3", 'award'=>"Yes",'izvodjac_id'=>"2", 'album_id'=>"2" ]);
        $pesma3 = Pesma::create(['name'=> "Wish you were here",'duration'=>"3", 'award'=>"Yes" ,'izvodjac_id'=>"1", 'album_id'=>"3"]);
    }
}
